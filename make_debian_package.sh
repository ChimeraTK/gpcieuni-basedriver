...
git clone . --branch ${GPCIEUNI_PACKAGE_VERSION} --single-branch ${CHECKOUT_DIRECTORY}
...
debchange --create --package gpcieuni-dkms -v ${GPCIEUNI_PACKAGE_VERSION}-${CODENAME}1 --distribution ${CODENAME} Debian package for the gpcieuni kernel module version ${GPCIEUNI_PACKAGE_VERSION}.
